...
#Input files
#dist_fp is a tab-delimited pairwise distance or similarity matrix for community structure.  Default is column names in row 1 and column 1.
#map_fp is a tab-delimited mapping file with samples in the same order as the distance file. One column name should be labeled "SiteID" to identify the group membership (categories) of the sample names in the distance matrix. Variation, sd, and MAD will be calculated among samples within these designated groups. 
